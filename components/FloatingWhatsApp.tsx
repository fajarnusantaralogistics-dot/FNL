...
export default function FloatingWhatsApp() {
  ...
  const phoneNumber = "6282156785580";
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Button */}
        <div className="relative flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-xl hover:scale-110 active:scale-95 transition-all duration-200">
          <svg
